 ...
 * {@link ImageLoader#getImageListener(ImageView, int, int, String)}. Note that all function calls to
...
public class ImageLoader {
    ...
    public static ImageListener getImageListener(final ImageView view,
                                                 final int defaultImageResId, final int errorImageResId, final String url) {
        return new ImageListener() {

            @Override
            public void onErrorResponse(VolleyError error) {
                Log.e("volley", url + " ..... error" + "endTime :" + System.currentTimeMillis());
            ...
            public void onResponse(ImageContainer response, boolean isImmediate) {
                Log.e("volley", url + " ..... success" + "endTime :" + System.currentTimeMillis());
                if (response.getBitmap() != null) {
                    Log.e("volley", url + "bitmap!=null");
